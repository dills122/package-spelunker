...
| M17-S01 | Write and approve the M1.7 public TypeScript API modeling specification | lead | M17-R01 and relevant ALPHA-D01 decisions | in progress | `docs/specs/` and contracts |
